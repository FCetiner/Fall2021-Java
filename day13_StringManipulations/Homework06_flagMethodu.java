...
public class Homework06_flagMethodu {
	...
	/*	Scanner scan=new Scanner(System.in);
		...
		String sifre = scan.next(); //next kullanarak þifrenin boþluk içermemesini saðladýk
		
		int uzunluk = sifre.length();
		char ilkharf = sifre.substring(0).charAt(0);
		char sonharf = sifre.substring((uzunluk-1), uzunluk).charAt(0);
		
		if (ilkharf>='A' && ilkharf<='Z' && uzunluk>=8 && sonharf>= 'a' && sonharf<= 'z' ) {
