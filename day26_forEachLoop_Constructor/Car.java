...
public class Car {
	...
	//methada benzer ama methoddan farklýdýr.
	...
	// method'dan birinci farký budur, methadlar kucuk harfle baþlar
	...
	//Bugün itibarýyle class'larda main methad olma mecburiyeti kaldýrýlmýþtýr :)
