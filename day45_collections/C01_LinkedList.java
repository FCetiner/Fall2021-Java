...
public class C01_LinkedList {
	...
	public static void main(String[] args) {
		...
		// birisi list, öteki de Deque ==> Queue
		
		ll.add(0,10);// List interface'den gelen özellikle baþa eleman ekleme
		System.out.println(ll); //[10, 5, 7]

		ll.addFirst(3);//queue interface den gelen özellikle baþa eleman ekleme
